...
function song4() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing (လွမ်း - ခင်မောင်တိုး)")
}
function song5() {
	b=13
	s11.pause()
...
function song6() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing (ငါ့ရဲ့လျှို့ဝှက်ချက် - ဖိုးကာ)")
}
function song7() {
	b=19
	s11.pause()
...
function song0() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing (အချစ်တေးကဗျာ - အောင်ထက်)")
}
function song12() {
	b=31
	s11.pause()
...
function song13() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing (မမြင့် - ပုံရိပ်)")
...
function song21() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing ချစ်သူ့ လက်ဆောင် - ထူးအိမ်သင်း")
} 
function song23() {
	b=61
	s11.pause()
...
function song26() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing ချစ်သူလမ်းကြား - စိုင်းအောင်ထီးခမ်း")
}
function song27() {
	b=73
	s11.pause()
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing ရေဒီယိုကမာရွတ် - စိုင်းထီးဆိုင်")
}
function song28() {
	b=76
	s11.pause()
...
function song29() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing ပြန်တွေးကြည့် - မိုးမိုး")
}
function song30() {
	b=82
	s11.pause()
...
function song32() {
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing တစ်စစီကျိုးပဲ့နေတယ် -အေးချမ်းမေ")
}
function song34() {
	b=91
	b=91
	...
	s37.pause()
		...
		start.style.display = "inline-block"
		stop1.style.display = "none"
		alert("You are playing [ကြည်ဖြူပါတော့ - စိုးသူ (ကြည်ဖြူပါ မေရယ်)]")
}
function song35() {
	b=94
	b=94
